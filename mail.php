...
<html lang="en">
<head>
<title>Online Photoshoot Booking System | Mail</title>
...
{               ?>
							<li><i class="fa fa-phone" aria-hidden="true"></i> <span>+9779818148323</span></li>
							<li><i class="fa fa-phone fa-envelope" aria-hidden="true"></i> <span>pranil2057@gmail.com</span></li>
							<li><i class="fa fa-map-marker" aria-hidden="true"></i> <span>Dallu,Kathmandu</span></li><?php $cnt=$cnt+1;}} ?>
						</ul>
					</div>
				</div>
