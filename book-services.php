...
$sql="insert into tblbooking(BookingID,ServiceID,UserID,BookingFrom,BookingTo,Numberofguest,Message)values(:bookingid,:bid,:uid,:bookingfrom,:bookingto,:nop,:message)";
...
<html lang="en">
<head>
<title>Online Photoshoot Booking System | Book Services</title>
